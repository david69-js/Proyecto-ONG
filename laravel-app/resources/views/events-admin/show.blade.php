                        ...
                        <table class="table table-sm">
                            ...
                            @if(($event->cost ?? 0) > 0)
                                <tr>
                                    ...
                                    <td class="text-success fw-bold">{{ $event->cost_formatted }}</td>
                                </tr>
                            @endif
                        </table>
                    </div>
        ...
        @if($event->project)
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{-- Si tu CRUD de proyectos también está bajo admin., cambia a route('admin.projects.show', $event->project) --}}
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    @can('update', $event)
                        <form method="POST" action="{{ route('admin.events.toggle_featured', $event) }}" class="d-inline">
                            @csrf
                            @method('PATCH')
                    ...
                    @can('update', $event)
                        <div class="btn-group w-100">
                            ...
                            <div class="dropdown-menu w-100 p-2">
                                {{-- La ruta definida para cambiar estado es POST admin.events.change-status --}}
                                <form method="POST" action="{{ route('admin.events.change-status', $event) }}" class="mb-1">
                                    @csrf
                                        ...
                                        <td>
                                            @can('update', $event)
                                                <div class="btn-group btn-group-sm">
                                                    ...
                                                    <form method="POST" action="{{ route('admin.registrations.update-status', $registration) }}" class="d-inline">
                                                        @csrf
                                                    ...
                                                    {{-- Eliminar registro --}}
                                                    <form method="POST" action="{{ route('admin.registrations.destroy', $registration) }}" class="d-inline" onsubmit="return confirm('¿Eliminar este registro?')">
                                                        @csrf
                                                        @method('DELETE')
